...
const handleSearchSubmit = async (searchTerm, results) => {
    try {
        setIsLoading(true);
        console.log("تم استلام بيانات البحث من SearchForm:", searchTerm);
        console.log("نتائج البحث المستلمة:", results); // ✅ تحقق مما إذا كانت البيانات وصلت

        setSearchResults(results); // ✅ تحديث `searchResults` بالنتائج المستلمة
    } catch (error) {
        ...
        <div className="home">
            ...
            <div>
                ...
                {isLoading ? (
                    ...
                    console.log(" يييوزربيانات البحث قبل عرضها:", searchResults),
